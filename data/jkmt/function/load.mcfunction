...
tellraw @a {text: "使用 任意材质的（剑） + 盾牌 + 铁锭 进行锻造，获得盾升级的剑。", color: "aqua"}
...
tellraw @a {text: "Putting your any-material-sword + shield + iron_ingot to SMITH sword-with-shield-upgrade.", color: "aqua"}
